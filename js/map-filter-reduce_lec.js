...
$(document).ready(function() {
    ...
    mbpModels.forEach(function (index){
       ids.push(index.id);
    });
    ...
    let idsES6 =  mbpModels.map(index => index.id);
    ...
    $('#reduceForEach').html(commaThousands(total))
    /********************************* 2 *********************************/
    //  2. Use reduce()

    let totalReduce = mbpModels.reduce(function (total, mbp) {
        return total + mbp.price;
    }, 0)

    $('#reduce').html(commaThousands(totalReduce));

    /********************************* 3 *********************************/
    //  3. Use ES6

    let reduceES6 = mbpModels.reduce((total,mbp) => total + mbp.price, 0);

    $('#reduceEs6').html(commaThousands(reduceES6));
