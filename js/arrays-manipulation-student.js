...
(function () {
    ...
    // POP QUIZ: What is the return of the function above?!
    ...
    cheeses.unshift('Red Windsor','Gouda','Havarti');
    console.log(cheeses);
    ...
    cheeses = cheeses.filter(cheese => cheese !== 'Red Windsor');
    ...
    cheeses = cheeses.filter(cheese => cheese !== 'Havarti');
    ...
    cheeses.unshift('Ragstone');

    var addCheese = cheeses.shift()
    ...
    console.log(cheeses[cheeses.indexOf('Ragstone')].indexOf('o'));
